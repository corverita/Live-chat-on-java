...
public class Gui1 extends javax.swing.JFrame {
     ...
     */
    public Gui1(String ipServer, int puertoServerMensajes, int puertoClienteMensajes, int puertoServerVideo, int puertoClienteVideo, int puertoServerArchivos, int puertoServerAudio, int puertoClienteAudio) throws Exception {
        initComponents();
